<?PHP
    class Database
    {
        ...
        private function __construct($connect = false)
        {
            ...
            //echo "<br> name = ".$this->username;
            //echo "<br> name = ".$this->password;
            //die ("<br>host  = ".$this->host); 
            if($connect === true)
                $this->connect();
                //echo "<br>returned from function";
                //echo "this connection state ".$this->isConnected();
                //echo "<br>true = ". true . "false = ".false;
                //die ();
        }
        ...
        public function connect()
        {
			...
			if($this->db->connect_errno <> 0) {return false;}
        ...
        public function query($sql, $args_to_prepare = null, $exception_on_missing_args = true)
        {
            ...
            //$this->link->query("SELECT * FROM '$name' LIMIT 1");
            return $this->result;
        }
