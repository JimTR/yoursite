...
if($Auth->loggedIn()) 
	...
	$page['navi'] ='<a href="index.php?activetab='.$activetab.'">Shop</a>';
	$page['newthread'] = 0;
	$page['usertitle'] = "";
	$page['pmnew'] = 0;
	...
	else
	{
			...
			else
			{
				...
				foreach ($post_data as $posts_row)
				{
					...
					$post_info['www']="";
					$post_info['iplogged']='';
					$post_info['buynow'] = $template->load('templates/buynow.html', COMMENT); // add the purchase button
					$post_info['payer'] = $site->settings['paypal_email'];
					...
					if($Auth->loggedIn()){
						...
						//$post_info['reply'] = setbutton("Reply",'templates/editorx.html',true,"iframeAnchor");
