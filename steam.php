<?php
 ...
 define('THIS_SCRIPT', 'steam.php');
require 'includes/master.inc.php'; // load required files
require_once 'includes/class.steam.php';
...
login ($steam_login_verify); // login routine
}
else
{
...
function login ($steam_login_verify)
{
	/*login or create a user
	 * overides register.php
	 */
		
		$url = 'http://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key='.$settings['steamkey'].'&steamids='.$steam_login_verify.'&format=xml';
